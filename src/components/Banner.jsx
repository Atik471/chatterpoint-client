...
const Banner = ({ setSelectedTag }) => {
  ...
  return (
    <div>
    <div className="bg-[url('/assets/banner.jpg')] bg-cover bg-center h-52 mt-5 md:mb-12 mb-4 rounded-2xl shadow-xl w-full">
      <form
        onSubmit={(e) => {
          e.preventDefault();
        }}
        className="flex justify-center items-center h-full md:w-[60%] w-[90%] mx-auto"
      >
        <select
          name="tags"
          placeholder="Tags"
